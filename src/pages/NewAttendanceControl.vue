      ...
      <div class="card">
        ...
        <Toolbar class="mb-4">
          <template v-slot:start>
            <div class="my-2">
              <Button label="Check in" class="p-button-success mr-2 mb-2" />
        ...
        >
          ...
          <Column
            field="numberofAssists"
            header="Number of assists"
            :sortable="true"
            headerStyle="width:14%; min-width:10rem;"
          >
            <template #body="slotProps">
              <span class="p-column-title">Number of assists</span>
              {{ slotProps.data.name }}
            </template>
          </Column>
          <Column
            field="numberofFouls"
            header="Number Of Fouls"
            :sortable="true"
            headerStyle="width:14%; min-width:10rem;"
          >
            <template #body="slotProps">
              <span class="p-column-title">Number Of Fouls</span>
              {{ slotProps.data.name }}
            </template>
          </Column>
          <Column
            field="cumulativeWorkinghours"
            header="Cumulative Working Hours"
            :sortable="true"
            headerStyle="width:14%; min-width:10rem;"
          >
            <template #body="slotProps">
              <span class="p-column-title">Cumulative Working Hours</span>
              {{ slotProps.data.name }}
            </template>
          </Column>
