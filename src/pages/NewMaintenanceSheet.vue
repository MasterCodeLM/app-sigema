<template>
      ...
      <div class="card p-fluid">
        ...
        <div class="grid">
          <div class="field col-12 sm:col-6">
            ...
            <Calendar :showIcon="true" :showButtonBar="true" v-model="calendarValue" :minDate="minDateValue"></Calendar>
          </div>
          ...
          <div class="field col-12 sm:col-6">
            ...
            <Dropdown id="state" v-model="dropdownItem" :options="dropdownItems" optionLabel="name"
                      placeholder="Select One" :filter="true" :loading="false"></Dropdown>
          </div>
          <div class="field col-12 sm:col-6">
    ...
    <div class="col-12 md:col-6">
      <div class="card p-fluid">
        ...
        <div class="field">
          ...
          <Textarea placeholder="Your Message" :autoResize="true" rows="12" cols="30"/>
        </div>
      </div>
    </div>
    <div class="col-12">
        ...
        <div class="p-fluid formgrid grid">
          <div class="field col-12 md:col-6 lg:col-4 xl:col-3">
            <div class="flex flex-column sm:flex-row">
              <Button label="Add Article" class="p-button-secondary mr-2 mb-2" @click="openNew"/>
              <Button label="Add Service" class="p-button-secondary mr-2 mb-2" @click="openNew"/>
            </div>
          </div>
          ...
          <div class="field col-12">
            <DataTable :value="products1" editMode="cell" @cell-edit-complete="onCellEditComplete"
  ...
  <Dialog v-model:visible="productDialog" :breakpoints="{'960px': '75vw', '640px': '100vw'}" :style="{width: '50vw'}" header="Add Articles" :modal="true"
          class="p-fluid">
