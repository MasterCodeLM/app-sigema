<template>
  <div>
    <div class="card">
      <h3>Icons</h3>
      <p>PrimeVue components internally use <a href="https://github.com/primefaces/primeicons" class="font-medium">PrimeIcons</a>
        library, the official icons suite from <a href="https://www.primetek.com.tr" class="font-medium">PrimeTek</a>.
      </p>
...
&lt;i class="pi pi-spin pi-spinner" style="font-size: 2rem"&gt;&lt;/i&gt;
      ...
      <h5>Constants</h5>
      <p>PrimeIcons constants API is provided to easily choose an icon with typescript e.g. when defining a menu
        model.</p>
      <pre v-code><code>
&lt;Menu :model="items" /&gt;
...
export default {
	data() {
      ...
      <h5>List of Icons</h5>
      <p>Here is the current list of PrimeIcons, more icons are added periodically. You may also <a
          href="https://github.com/primefaces/primeicons/issues" class="font-medium">request new icons</a> at the issue
        tracker.</p>
